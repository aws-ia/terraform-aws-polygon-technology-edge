...
For more information about Polygon Edge, refer to the [Polygon Edge documentation](https://docs.polygon.technology/docs/edge/overview/).
...
This Partner Solution deploys into a new VPC. As shown in the diagram, it sets up the following:
