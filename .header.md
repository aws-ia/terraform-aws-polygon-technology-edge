...
For more information about Polygon Edge, visit the [Polygon website](https://polygon.technology/) and the [Polygon Edge documentation](https://docs.polygon.technology/docs/edge/overview/).
